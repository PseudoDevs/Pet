                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="username" name="user-email" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="password">Password <span class="required">*</span></label>
                                        <input id="password" name="user-pass" class="form-control" type="password">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group account-info-group mb--0">
                                        <a class="lost-password" href="/register">Register</a>
                                    </div>
                                </div>
